...
export const RESERVATION_TYPES = {
  '1hour': { label: '1 Hour', price: 300, duration: 1 },
  '2hours': { label: '2 Hours', price: 500, duration: 2 },
  '3hours': { label: '3 Hours', price: 750, duration: 3 },
  'vip4hours': { label: 'VIP 4 Hours', price: 950, duration: 4 }
} as const;
